usuarios-- Configuración inicial
...
CREATE DATABASE IF NOT EXISTS `Venta` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `Venta`;
...
(1, 'Mike Cotzojay', 'mikeovidio11@gmail.com', 'admin', 'Administrador');
...
ALTER TABLE `productos` ADD PRIMARY KEY (`id`), ADD KEY `proveedor` (`proveedor`);
ALTER TABLE `usuarios` ADD PRIMARY KEY (`id`);
ALTER TABLE `ventas` ADD PRIMARY KEY (`id`), ADD KEY `cliente` (`cliente`);
ALTER TABLE `detalle` ADD PRIMARY KEY (`id`), ADD KEY `id_venta` (`id_venta`), ADD KEY `id_pro` (`id_pro`);
...
ALTER TABLE `proveedor` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `productos` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `usuarios` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
ALTER TABLE `ventas` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `detalle` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
